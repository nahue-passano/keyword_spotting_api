...
def Keyword_Spotting_Service(model_path = 'flask_api/keyword_spotting_service/CNNmodel.h5'):
...
if __name__ == '__main__':
    ...
    model_path = 'flask_api/keyword_spotting_service/CNNmodel.h5'
    kss = Keyword_Spotting_Service(model_path)

    prediction_down = kss.predict('flask_api/keyword_spotting_service/test_prediction/down.wav')
    print(f'Audio: down / Prediction: {prediction_down}')

    prediction_nine = kss.predict('flask_api/keyword_spotting_service/test_prediction/nine.wav')
